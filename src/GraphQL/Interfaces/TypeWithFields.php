<?php
/**
 * Interface for classes that register a GraphQL type with fields to the GraphQL schema.
 *
...
if ( ! interface_exists( '\\AxeWP\\Common\\GraphQL\\Interfaces\\TypeWithFields' ) ) { // @codeCoverageIgnore
