# Security Policy for AxeWP Common

At **AxePress Development**, we take the security of our software products and services seriously. This document outlines how you can report vulnerabilities and how we handle them to ensure our users' safety.

## Reporting a Vulnerability

If you discover any security vulnerability in **AxeWP Common**, please follow these steps:

1. **Private Disclosure:**
   Do not publicly disclose vulnerabilities. Instead, report the issue by emailing us at [support@axepress.dev](mailto:support@axepress.dev).
...
Thank you for helping us keep `AxeWP Common` secure!
